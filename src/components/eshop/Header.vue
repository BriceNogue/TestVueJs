  ...
  <div class="Header">
    <template>
      ...
      <div
        class="card cart"
        :class="{
          'cart-close': isCartOpen === false,
          'cart-open': isCartOpen === true,
        }"
      >
        ...
        <div class="card-body">
          <div class="card" v-for="prod in store.cart" :key="prod.id">
            <div>
              <div>
            ...
            <div class="card-actions">
              <div>
                <b-icon
                  icon="cart-x"
                  @click.prevent="removeProduct(prod)"
                  class="cash-coin"
                  aria-hidden="true"
                ></b-icon>
              </div>
